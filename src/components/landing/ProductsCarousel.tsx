...
// As importações locais foram removidas temporariamente para não quebrar o Vite.
// Quando tiver as imagens reais, salve-as na pasta src/assets e importe-as novamente!
...
const produtos = [
  {
    ...
    image: "https://placehold.co/800x450/e2e8f0/64748b?text=Imagem+Apolice+System", // Imagem temporária
  ...
  },
  {
    ...
    image: "https://placehold.co/800x450/e2e8f0/64748b?text=Imagem+Pets+Admin", // Imagem temporária
  ...
  },
  {
    ...
    image: "https://placehold.co/800x450/e2e8f0/64748b?text=Imagem+Loja+Quinta", // Imagem temporária
  ...
  },
  {
    ...
    image: "https://placehold.co/800x450/e2e8f0/64748b?text=Imagem+GestJus", // Imagem temporária
      ...
      <div className="container mx-auto px-4 max-w-7xl relative">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="hidden md:flex gap-3">
            <button 
              onClick={prevSlide} 
              className="p-3 rounded-full border border-gray-200 bg-white text-gray-600 hover:text-primary hover:border-primary transition-all shadow-sm"
        ...
        <div className="overflow-hidden w-full">
          ...
          >
            {produtos.map((produto) => (
              <div 
                key={produto.id} 
                className="w-full md:w-[calc(50%-0.75rem)] flex-shrink-0 flex flex-col bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg transition-shadow duration-300 p-8"
              >
                ...
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="flex gap-2 flex-wrap justify-end max-w-[60%]">
                    {produto.tags.map(tag => (
                      <span key={tag} className="px-3 py-1 bg-[#e6f6ff] text-[#00a8ff] text-xs font-semibold rounded-full">
                        {tag}
                      </span>
                    ))}
                  </div>
                ...
                <div className="rounded-xl overflow-hidden mb-6 aspect-[16/9] flex items-center justify-center bg-gray-50 border border-gray-100">
                  <img 
                    src={produto.image} 
                    alt={`Interface do ${produto.title}`} 
        ...
        <div className="flex md:hidden justify-center gap-4 mt-8">
          <button 
            onClick={prevSlide} 
            className="p-3 rounded-full border border-gray-200 bg-white text-gray-600 hover:text-primary transition-all shadow-sm"
          >
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button 
